      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm font-semibold">
            ...
            <a href="/auto-loan-calculator" className="hover:text-blue-700 transition">Auto Loans</a>
            <a href="/personal-loan-calculator" className="hover:text-blue-700 transition">Personal Loans</a>
            <a href="/mortgage-calculator" className="hover:text-blue-700 transition">Mortgage</a>
            <a href="/debt-to-income-calculator" className="hover:text-blue-700 transition">DTI Calculator</a>
          </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="bg-white rounded-3xl border border-slate-200 p-10 shadow-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <a href="/auto-loan-calculator" className="border border-slate-200 rounded-2xl p-8 hover:shadow-md transition block">
            ...
            <a href="/personal-loan-calculator" className="border border-slate-200 rounded-2xl p-8 hover:shadow-md transition block">
              <div className="text-5xl mb-5">💳</div>
              <h3 className="text-2xl font-bold mb-4">Personal Loan Calculator</h3>
              <p className="text-slate-600 leading-relaxed">
                Preview personal loan repayment options.
              </p>
            </a>

            <a href="/mortgage-calculator" className="border border-slate-200 rounded-2xl p-8 hover:shadow-md transition block">
              <div className="text-5xl mb-5">🏠</div>
